...
## What we did
Ran PMGen structure predictions for all binder and non-binder peptide-MHC 
complexes on GPU nodes (A100). Each chunk was submitted as a separate 
...
## Storage
- `/projects/scc/MPG/MGMN/scc_mgmn_soeding/dir.project/hasmig/outputs/binder/`
